...
export default function Fotter() {
  return (
    <div className="bg-white pt-4 sm:pt-10 lg:pt-12">
      <footer className="max-w-screen-xl px-4 md:px-8 mx-auto">
        <div className="grid grid-cols- md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12">
        ...
        <div className="text-gray-400 text-sm text-center border-t py-4">
          © 2024 - Present  TPiINFO. All rights reserved.
        </div>
      </footer>
    </div>
  )
